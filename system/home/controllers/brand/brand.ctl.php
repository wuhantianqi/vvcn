    ...
    { 
       ...
       // }
        ...
        if($items = K::M('product/product')->items($filter, $orderby, $page, $limit, $count)){
            $pager['count'] = $count;
            $pager['pagebar'] = $this->mkpage($count, $limit, $page, $this->mklink('brand/brand:index', array($brand_id,$cat_id, $attr_ids, $order, '{page}'), array(), true),array('kw' => $pager['sokw']));
        ...
        $order_link = array();
        $order_link['default'] = $this->mklink('brand/brand:index', array($cat_id, $brand_id, $attr_ids, 0, 1));
        $order_link['buy'] = $this->mklink('brand/brand:index', array($cat_id, $brand_id, $attr_ids, 1, 1));
        $order_link['price'] = $this->mklink('brand/brand:index', array($cat_id, $brand_id, $attr_ids, 2, 1));
