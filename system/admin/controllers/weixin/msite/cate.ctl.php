...
class Ctl_Weixin_Msite_Cate extends Ctl
{
    ...
    public function index($page=1)
    {
        ...
        $this->tmpl = 'admin:weixin/msite/cate/items.html';
    }
    ...
    public function create()
    {
        if($data = $this->checksubmit('data')){
            ...
            if($cat_id = K::M('msite/cate')->create($data)){
                $this->err->add('添加内容成功');
                $this->err->set_data('forward', '?weixin/msite/cate-index.html');
            } 
        }else{
           $this->tmpl = 'admin:weixin/msite/cate/create.html';
        }
    }
    ...
    public function edit($cat_id=null)
    {
        if(!($cat_id = (int)$cat_id) && !($cat_id = $this->GP('cat_id'))){
        	...
        	$this->tmpl = 'admin:weixin/msite/cate/edit.html';
        }
    }
